...
/*        setSysDate(new SimpleDateFormat("yyyy-MM-dd HH:mm:ss", Locale.ENGLISH).format(new Date().getTime()));
    ...
    public void setD326(String d326) {
        ...
        setD330(d326.equals("2") ? this.d330 : "");
    ...
    public void setD328(String d328) {
        ...
        setD330(d328.equals("2") ? this.d330 : "");
    ...
    @Bindable
    public String getD330() {
        return d330;
    }

    public void setD330(String d330) {
        this.d330 = d330;
        notifyPropertyChanged(BR.d330);
    }
    ...
    public ModuleD Hydrate(Cursor cursor) throws JSONException {
        ...
        sD1Hydrate(cursor.getString(cursor.getColumnIndexOrThrow(FormsTable.COLUMN_SA1)));
        sD2Hydrate(cursor.getString(cursor.getColumnIndexOrThrow(FormsTable.COLUMN_SA2)));
        sD3Hydrate(cursor.getString(cursor.getColumnIndexOrThrow(FormsTable.COLUMN_SA3)));
        sD4Hydrate(cursor.getString(cursor.getColumnIndexOrThrow(FormsTable.COLUMN_SA4)));
        return this;
    }
    ...
    public JSONObject toJSONObject() throws JSONException {
        ...
        json.put(FormsTable.COLUMN_SA1, new JSONObject(sD1toString()));
        json.put(FormsTable.COLUMN_SA2, new JSONObject(sD2toString()));
        json.put(FormsTable.COLUMN_SA3, new JSONObject(sD3toString()));
        json.put(FormsTable.COLUMN_SA4, new JSONObject(sD4toString()));
        return json;
    }
