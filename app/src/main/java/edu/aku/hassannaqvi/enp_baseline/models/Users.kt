...
import edu.aku.hassannaqvi.enp_baseline.core.MainApp._EMPTY_
...
class Users {
    ...
    fun sync(jsonObject: JSONObject): Users {
        ...
        districtCode = jsonObject.getString(UsersTable.COLUMN_DISTRICT_CODE)
    ...
    fun hydrate(cursor: Cursor): Users {
        ...
        districtCode =
            cursor.getString(cursor.getColumnIndexOrThrow(UsersTable.COLUMN_DISTRICT_CODE))
