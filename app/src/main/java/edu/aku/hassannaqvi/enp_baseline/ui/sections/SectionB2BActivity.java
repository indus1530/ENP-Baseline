...
import edu.aku.hassannaqvi.enp_baseline.databinding.ActivitySectionB2bBinding;
import edu.aku.hassannaqvi.enp_baseline.ui.EndingActivity;


public class SectionB2BActivity extends AppCompatActivity {

    private static final String TAG = "SectionB2BActivity";
    ActivitySectionB2bBinding bi;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bi = DataBindingUtil.setContentView(this, R.layout.activity_section_b2b);
