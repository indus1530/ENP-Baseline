...
object CreateTable {
    ...
    const val SQL_CREATE_WANTHRO = ("CREATE TABLE "
            + WAnthroTable.TABLE_NAME + "("
            + WAnthroTable.COLUMN_ID + " INTEGER PRIMARY KEY AUTOINCREMENT,"
            + WAnthroTable.COLUMN_PROJECT_NAME + " TEXT,"
            + WAnthroTable.COLUMN_UID + " TEXT,"
            + WAnthroTable.COLUMN_UUID + " TEXT,"
            + WAnthroTable.COLUMN_FMUID + " TEXT,"
            + WAnthroTable.COLUMN_SNO + " TEXT,"
            + WAnthroTable.COLUMN_PSU_CODE + " TEXT,"
            + WAnthroTable.COLUMN_HHID + " TEXT,"
            + WAnthroTable.COLUMN_USERNAME + " TEXT,"
            + WAnthroTable.COLUMN_SYSDATE + " TEXT,"
            + WAnthroTable.COLUMN_INDEXED + " TEXT,"
            + WAnthroTable.COLUMN_ISTATUS + " TEXT,"
            + WAnthroTable.COLUMN_DEVICEID + " TEXT,"
            + WAnthroTable.COLUMN_DEVICETAGID + " TEXT,"
            + WAnthroTable.COLUMN_SYNCED + " TEXT,"
            + WAnthroTable.COLUMN_SYNCED_DATE + " TEXT,"
            + WAnthroTable.COLUMN_APPVERSION + " TEXT,"
            + WAnthroTable.COLUMN_SF2 + " TEXT"
            + " );"
            )
    ...
    const val SQL_CREATE_CANTHRO = ("CREATE TABLE "
            + CAnthroTable.TABLE_NAME + "("
            + CAnthroTable.COLUMN_ID + " INTEGER PRIMARY KEY AUTOINCREMENT,"
            + CAnthroTable.COLUMN_PROJECT_NAME + " TEXT,"
            + CAnthroTable.COLUMN_UID + " TEXT,"
            + CAnthroTable.COLUMN_UUID + " TEXT,"
            + CAnthroTable.COLUMN_FMUID + " TEXT,"
            + CAnthroTable.COLUMN_MUID + " TEXT,"
            + CAnthroTable.COLUMN_PSU_CODE + " TEXT,"
            + CAnthroTable.COLUMN_HHID + " TEXT,"
            + CAnthroTable.COLUMN_SNO + " TEXT,"
            + CAnthroTable.COLUMN_USERNAME + " TEXT,"
            + CAnthroTable.COLUMN_SYSDATE + " TEXT,"
            + CAnthroTable.COLUMN_INDEXED + " TEXT,"
            + CAnthroTable.COLUMN_ISTATUS + " TEXT,"
            + CAnthroTable.COLUMN_DEVICEID + " TEXT,"
            + CAnthroTable.COLUMN_DEVICETAGID + " TEXT,"
            + CAnthroTable.COLUMN_SYNCED + " TEXT,"
            + CAnthroTable.COLUMN_SYNCED_DATE + " TEXT,"
            + CAnthroTable.COLUMN_APPVERSION + " TEXT,"
            + CAnthroTable.COLUMN_SF1 + " TEXT"
            + " );"
            )
